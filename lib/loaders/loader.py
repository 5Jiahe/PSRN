...
class Loader(object):
    ...
    def fetch_sub(self, sent_id):
        # return int32 (label_length, )
        sub_wordid = self.Sentences[sent_id]['sub_wordid']
        return sub_wordid

    def fetch_cls(self, sent_id):
        # return int32 (label_length, )
        cls_wordid = self.Sentences[sent_id]['sub_classwordid']
        return cls_wordid

    def fetch_obj(self, sent_id):
        # return int32 (label_length, )
        obj_wordid = self.Sentences[sent_id]['obj_wordid']
        return obj_wordid

    def fetch_rel(self, sent_id):
        # return int32 (label_length, )
        rel_wordid = self.Sentences[sent_id]['rel_wordid']
        return rel_wordid
